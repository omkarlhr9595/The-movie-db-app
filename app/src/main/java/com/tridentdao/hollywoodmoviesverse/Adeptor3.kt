...
class Adeptor3(private val listener: MovieItemClicked) : RecyclerView.Adapter<Card3>() {

    private val items: ArrayList<MovieList> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Card3 {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.card, parent, false)
        val viewHolder = Card3(view)
    ...
    override fun onBindViewHolder(holder: Card3, position: Int) {
